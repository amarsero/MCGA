...
namespace ASF.Services.Http
{
    ...
    public class CartItemService : ApiController
    {
        ...
        public AllResponse<CartItem> All()
        {
            try
            {
                AllResponse<CartItem> response = new AllResponse<CartItem>();
                var bc = new CartItemBusiness();
        ...
        public FindResponse<CartItem> Find(int id)
        {
            try
            {
                FindResponse<CartItem> response = new FindResponse<CartItem>();
                var bc = new CartItemBusiness();
        ...
        [HttpGet]
        [Route("AllByCart/{cartId}")]
        public AllResponse<CartItem> AllByCart(int cartId)
        {
            try
            {
                AllResponse<CartItem> response = new AllResponse<CartItem>();
                var bc = new CartItemBusiness();
                response.Result = bc.AllByCart(cartId);
                return response;
            }
            catch (Exception ex)
            {
